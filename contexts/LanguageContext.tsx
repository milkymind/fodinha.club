...
const translations = {
  en: {
    ...
    'win_percentage_desc': 'Percentage of games won out of total games played',
  ...
  pt: {
    ...
    'win_percentage': 'Porcentagem de Vitórias',
    'win_percentage_desc': 'Porcentagem de jogos ganhos em relação ao total de jogos jogados',
